...
public class Real_Estate {
	...
	public void Agent_Login(String[] args) throws InterruptedException {
	...
	//Agent 
		...
		@Test(priority=0)		
		public void Post_Property() throws InterruptedException, IOException {
...
//Maintenance Charge per month
   ...
   //Admin Approves Property
		...
		@Test(priority=1)
        public void Admin(String[] args) throws InterruptedException {
        ...
        //User Searches Property
			...
			@Test(priority=2)
            public void User(String[] args) throws InterruptedException {
